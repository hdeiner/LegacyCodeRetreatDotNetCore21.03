...
namespace TimeTeller
{
    public class TimeTellerTests
    {
        ...
        {
            Assert.Matches("^(\\s|one|two|three|four|five|six|seven|eight|nine|ten|eleven|twelve|twenty|about|almost|a|little|after|quarter|half|of|past|before|at|night|in|the|morning|afternoon|evening|night)+$", TimeTeller.GetResult(TimeZones.LOCAL, TimeFormatting.APPROXIMATE_WORDING, false));
        }
