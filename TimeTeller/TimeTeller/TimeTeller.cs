...
namespace TimeTeller
{
    public class TimeTeller
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(GetResult(TimeZones.LOCAL, TimeFormatting.NUMERIC, false));
            Console.WriteLine(GetResult(TimeZones.UTC, TimeFormatting.NUMERIC, false));
            Console.WriteLine(GetResult(TimeZones.LOCAL, TimeFormatting.APPROXIMATE_WORDING, false));
            Console.WriteLine(GetResult(TimeZones.UTC, TimeFormatting.APPROXIMATE_WORDING, false));
            Console.WriteLine(GetResult(TimeZones.LOCAL, TimeFormatting.NUMERIC, true));
            Console.WriteLine(GetResult(TimeZones.UTC, TimeFormatting.NUMERIC, true));
            Console.WriteLine(GetResult(TimeZones.LOCAL, TimeFormatting.APPROXIMATE_WORDING, true));
            Console.WriteLine(GetResult(TimeZones.UTC, TimeFormatting.APPROXIMATE_WORDING, true));
            Console.Read();
        }
